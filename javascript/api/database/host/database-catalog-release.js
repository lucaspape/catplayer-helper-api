...
mysqlConnection.connect(err => {
  if (err) {
    ...
    const createArtistsTableQuery = 'CREATE TABLE IF NOT EXISTS `' + dbName + '`.`catalogReleases` ( `sortId` INT AUTO_INCREMENT PRIMARY KEY, `trackIds` TEXT, `releaseId` TEXT, `mcID` TEXT PRIMARY KEY);';
